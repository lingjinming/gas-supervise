...
declare namespace UniCloudNamespace {
  ...
  interface ParseSystemErrorParams {
    /**
     * 云对象名
     */
    objectName: string;
  ...
  interface ImportObjectOptions {
     ...
     */
    parseSystemError?: (params: ParseSystemErrorParams) => Promise<ParsedSystemErrorResult> | ParsedSystemErrorResult;
  }
  ...
  interface InitSecureNetworkByWeixinParams {
  ...
  interface UniCloud {
     ...
     */
    getFileInfo(options: GetFileInfoParams): Promise<GetFileInfoResponse>;
    /**
     * 获取数据库实例
     *
     ...
     */
    initSecureNetworkByWeixin(params: InitSecureNetworkByWeixinParams): Promise<InitSecureNetworkByWeixinResponse>;
    /** 事件回调 */
